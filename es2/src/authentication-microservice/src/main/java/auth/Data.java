...
public abstract class Data {
    ...
    protected static <R extends Data> R fromJSON(String representation, Class<R> type) throws IOException {
        return jsonMapper.readValue(representation, type);
    }

    protected static <R extends Data> R fromYAML(String representation, Class<R> type) throws IOException {
        return yamlMapper.readValue(representation, type);
    }

    protected static <R extends Data> R fromXML(String representation, Class<R> type) throws IOException {
        return xmlMapper.readValue(representation, type);
    }

    protected static <R extends Data> R parse(String mimeType, String representation, Class<R> type) throws IOException {
